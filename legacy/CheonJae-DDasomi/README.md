...
- Root: `CheonJae-DDasomi/backend`, `pip install -r requirements.txt`, `uvicorn app.main:app --host 0.0.0.0 --port $PORT`
...
2. **Root Directory**를 `CheonJae-DDasomi/frontend`로 지정 (Next.js 자동 인식)
